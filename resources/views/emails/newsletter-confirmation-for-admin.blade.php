...
<body style="width: 80%; margin-left: 10%; font-family: 'Barlow';">
    ...
    <div>
        ...
        <p>
            Une nouvelle demande d'inscription à la newsletter a été envoyée depuis <span style="color: #D41C1B;">BENU VILLAGE</span> ! Les coordonnées de la personne sont les suivantes :
        </p>
        <ul>
